			...
			<main>
				<div class="container-fluid px-4">
					...
					<div class="container-fluid">
						<div class="row">
							<a href="<?php echo base_url('/welcome/tambahpelanggan'); ?>" class="btn btn-success"
							...
							<div class="container ">
								<table class="table">
									...
									<tr class="table-light">
										<td><?php echo $no++ ?></td>
										<td><?php echo $plgn->nama_pelanggan ?></td>
										<td><?php echo $plgn->jenis_kelamin ?></td>
										<td><?php echo $plgn->telepon ?></td>
										<td><?php echo $plgn->alamat ?></td>
										<td>
											<?php echo anchor('/c_pelanggan/aksi_edit/'.$plgn->id_pelanggan, '<div class="btn btn-info"><i class="fa fa-edit"></i> Edit</div>') ?>
										</td>
										<td onclick="javascript: return confirm('Anda yakin hapus data ini?') ">
											<?php echo anchor('/c_pelanggan/aksi_hapus/'.$plgn->id_pelanggan, '<div class="btn btn-danger"><i class="fa fa-trash"></i> Hapus</div>') ?>
										</td>
									</tr>
									<?php endforeach; ?>
								</table>
