...
<body>
	...
	<div class="limiter">
		<div class="container-login100"
			style="background-image: url('<?php echo base_url() ?>assets/images/asal.jpg');">
			<div class="wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33">
				<form class="login100-form validate-form flex-sb flex-w" action="<?php echo base_url('c_register/index');?>" method="post">
					...
					<div class="wrap-input100 validate-input" data-validate="Name Admin is required">
					...
					<div class="w-full text-center p-t-55">
						...
						<a href="<?php echo base_url('c_auth/login') ?>" class="txt2 bo1">
							Sign in now
						</a>
					</div>
				</form>
