				...
				<div class="container-fluid px-4">
					...
					<div class="container ">
						<div>
							...
							<form method="post" action="<?php echo base_url().'/c_obat/update' ?>">
								<input type="hidden" name="id_obat" placeholder="Id"
									class="form-control rounded-pill mt-3 mb-3" value="<?php echo $obt->id_obat ?>">
						</div><br>
						<div class="form-group">
							<label>Nama Obat</label>
							<br>
							<input type="text" name="nama_obat" class="form-control rounded-pill mt-3"
								value="<?php echo $obt->nama_obat ?>">
						</div><br>
						<div class="form-group">
							<label>Stok Obat</label>
							<br>
							<input type="text" name="stok" class="form-control rounded-pill mt-3"
								value="<?php echo $obt->stok ?>">
						</div><br>
						<div class="form-group">
							<label>Harga Obat</label>
							<br>
							<input type="text" name="harga_obat" class="form-control rounded-pill mt-3"
								value="<?php echo $obt->harga_obat ?>">
						</div><br>
						<div class="form-group">
							<label>Detail Obat</label>
							<br>
							<input type="text" name="detail_obat" class="form-control rounded-pill mt-3"
								value="<?php echo $obt->detail_obat ?>">
						</div><br>
						<div class="form-group">
							<label>Status</label>
							<br>
							<select type="text" name="Status" placeholder="Status"
								class="form-control rounded-pill mt-3" value="<?php echo $obt->Status ?>">
