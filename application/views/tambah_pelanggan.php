		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid px-4">
					...
					<div class="container ">
						<div>
							<form action="<?php echo base_url('index.php/c_pelanggan/aksi_input');?>" method="post">
								<input type="hidden" name="id_pelanggan" placeholder="Id Pelanggan"
									class="form-control rounded-pill mt-3 mb-3">
								...
								<div class="form-group">
									<button class="btn btn-success mt-3 baris2"><i class="fa fa-plus"></i>
										Tambah</button>
