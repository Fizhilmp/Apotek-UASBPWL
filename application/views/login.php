	...
	<div class="limiter">
		<div class="container-login100"
			...
			<div class="wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33">
				...
				<form class="login100-form validate-form flex-sb flex-w" action="<?php echo base_url('c_auth/login');?>"
					method="post">
					...
					<div class="container-login100-form-btn m-t-17">
						<button type="submit" class="login100-form-btn form-control">Sign In</button>
					</div>
					...
					<div class="w-full text-center p-t-55">
						...
						<a href="<?php echo base_url('c_register/index') ?>" class="txt2 bo1">
							Sign up now
						</a>
					</div>
				</form>
